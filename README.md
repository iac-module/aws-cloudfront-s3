...
| <a name="module_s3_buckets"></a> [s3\_buckets](#module\_s3\_buckets) | git::https://github.com/terraform-aws-modules/terraform-aws-s3-bucket.git//. | 8a0b697adfbc673e6135c70246cff7f8052ad95a |
...
| [aws_iam_policy_document.s3_p](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_cloudfront_keys"></a> [cloudfront\_keys](#input\_cloudfront\_keys) | The Cloudfront keys | <pre>object({<br>    name = optional(string, "default")<br>    secrets = optional(map(object({<br>      secret_manager_name = string<br>      secret_manager_key  = string<br>      })), {}<br>    )<br>  })</pre> | `{}` | no |
...
| <a name="output_s3_buckets"></a> [s3\_buckets](#output\_s3\_buckets) | The ARN of the bucket. Will be of format arn:aws:s3:::bucketname. |
| <a name="output_s3_buckets_arns"></a> [s3\_buckets\_arns](#output\_s3\_buckets\_arns) | The arns of s3 buckets. |
